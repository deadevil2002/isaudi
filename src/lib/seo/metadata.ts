...
export const BRAND_ICON_PATH = '/brand/isaudi-mark-v4';
export const BRAND_APPLE_ICON_PATH = '/brand/isaudi-apple-touch-v4';
export const SOCIAL_IMAGE_PATH = '/brand/isaudi-social-v4';
